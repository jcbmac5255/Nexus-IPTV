...
-keepclassmembers class com.nexus.iptv.data.remote.** { <fields>; }
...
-keep class com.nexus.iptv.domain.model.** { *; }
-keep class com.nexus.iptv.data.local.entity.** { *; }
-keep class com.nexus.iptv.data.remote.xtream.model.** { *; }

# ── Security / TLS ──────────────────────────────────────────
-keepnames class com.nexus.iptv.data.security.CredentialCrypto
-keepclassmembers class com.nexus.iptv.data.security.CredentialCrypto {
    <fields>;
    <methods>;
}
