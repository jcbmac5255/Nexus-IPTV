package com.nexus.iptv.plugins

object StreamVaultPluginContract {
    const val API_VERSION = 1

    const val ACTION_PLUGIN_SERVICE = "com.nexus.iptv.plugin.API"
    const val META_MANIFEST_JSON = "com.nexus.iptv.plugin.MANIFEST_JSON"
    const val META_ID = "com.nexus.iptv.plugin.ID"
    const val META_NAME = "com.nexus.iptv.plugin.NAME"
    const val META_VERSION_NAME = "com.nexus.iptv.plugin.VERSION_NAME"
    const val META_VERSION_CODE = "com.nexus.iptv.plugin.VERSION_CODE"
    const val META_DESCRIPTION = "com.nexus.iptv.plugin.DESCRIPTION"
    const val META_CAPABILITIES = "com.nexus.iptv.plugin.CAPABILITIES"
    const val META_CONFIGURATION_MODE = "com.nexus.iptv.plugin.CONFIGURATION_MODE"
    const val META_CONFIGURATION_ACTIVITY_ACTION = "com.nexus.iptv.plugin.CONFIGURATION_ACTIVITY_ACTION"
    const val META_PROVIDER_NAME = "com.nexus.iptv.plugin.PROVIDER_NAME"
