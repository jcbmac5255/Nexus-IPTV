package com.nexus.iptv.ui.screens.series
...
import com.nexus.iptv.ui.components.SearchInput
...
import com.nexus.iptv.ui.components.SavedCategoryContextCard
import com.nexus.iptv.ui.components.SavedCategoryShortcut
import com.nexus.iptv.ui.components.SavedCategoryShortcutsRow
...
import com.nexus.iptv.domain.model.LibraryFilterType
import com.nexus.iptv.domain.model.LibrarySortBy
...
import com.nexus.iptv.ui.components.ReorderTopBar
import com.nexus.iptv.ui.components.dialogs.DeleteGroupDialog
import com.nexus.iptv.ui.components.dialogs.RenameGroupDialog
import com.nexus.iptv.ui.components.shell.BrowseHeroPanel
import com.nexus.iptv.ui.components.shell.BrowseSearchLaunchCard
import com.nexus.iptv.ui.components.shell.LoadMoreCard
import com.nexus.iptv.ui.components.shell.InfiniteScrollEffect
import com.nexus.iptv.ui.components.shell.AppNavigationChrome
import com.nexus.iptv.ui.components.shell.AppMessageState
import com.nexus.iptv.ui.components.shell.AppScreenScaffold
import com.nexus.iptv.ui.components.shell.VodActionChip
import com.nexus.iptv.ui.components.shell.VodActionChipRow
import com.nexus.iptv.ui.components.shell.VodCategoryOption
import com.nexus.iptv.ui.components.shell.VodCategoryPickerDialog
import com.nexus.iptv.ui.components.shell.VodBrowseOptionsDialog
import com.nexus.iptv.ui.components.shell.VodClassicCategoryOption
import com.nexus.iptv.ui.components.shell.VodClassicContentHeader
import com.nexus.iptv.ui.components.shell.VodClassicSplitLayout
import com.nexus.iptv.ui.components.shell.VodHeroStrip
import com.nexus.iptv.ui.components.shell.VodSectionHeader
import com.nexus.iptv.ui.design.FocusRestoreHost
import com.nexus.iptv.ui.design.requestFocusSafely
import com.nexus.iptv.ui.model.VodViewMode
import com.nexus.iptv.ui.screens.vod.HandleVodUserMessage
import com.nexus.iptv.ui.screens.vod.ProtectedVodPinDialog
import com.nexus.iptv.ui.screens.vod.VodBrowseDefaults
import com.nexus.iptv.ui.screens.vod.vodActiveFilterSortDetail
...
fun SeriesScreen(
    ...
    if (uiState.showDialog && uiState.selectedSeriesForDialog != null) {
        ...
        com.nexus.iptv.ui.components.dialogs.AddToGroupDialog(
    ...
    if (uiState.selectedCategoryForOptions != null) {
        ...
        com.nexus.iptv.ui.components.dialogs.CategoryOptionsDialog(
            category = category,
        ...
        buildMap<String, Category> {
            ...
            put(
                ...
                Category(
                    ...
                    type = com.nexus.iptv.domain.model.ContentType.SERIES,
                    isVirtual = true
                )
            )
        }
