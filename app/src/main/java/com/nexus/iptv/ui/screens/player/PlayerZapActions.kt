    ...
    viewModelScope.launch {
        withScopedScrubbingMode(playerEngine::setScrubbingMode) {
            ...
            playerEngine.playbackState
                .filter {
                    it == com.nexus.iptv.player.PlaybackState.READY ||
...
internal fun PlayerViewModel.recordLivePlayback(channel: com.nexus.iptv.domain.model.Channel) {
...
internal fun PlayerViewModel.resolveChannelByNumber(number: Int?): com.nexus.iptv.domain.model.Channel? {
    if (number == null) return null
    return channelNumberIndex[number]
}

internal fun PlayerViewModel.resolveChannelByPrefix(prefix: String): com.nexus.iptv.domain.model.Channel? {
