...
import com.nexus.iptv.update.AppUpdateDownloadState
import com.nexus.iptv.update.AppUpdateDownloadStatus
import com.nexus.iptv.update.AppUpdateInstaller
import com.nexus.iptv.update.GitHubReleaseChecker
import com.nexus.iptv.update.GitHubReleaseInfo
...
import com.nexus.iptv.data.sync.SyncRepairSection
...
import com.nexus.iptv.domain.manager.DriveBackupSyncManager
...
import com.nexus.iptv.domain.usecase.ExportBackup
import com.nexus.iptv.domain.usecase.ExportBackupCommand
import com.nexus.iptv.domain.usecase.ExportBackupResult
import com.nexus.iptv.domain.usecase.ImportBackup
import com.nexus.iptv.domain.usecase.ImportBackupCommand
import com.nexus.iptv.domain.usecase.ImportBackupResult
import com.nexus.iptv.domain.usecase.InspectBackupCommand
import com.nexus.iptv.domain.usecase.InspectBackupResult
...
import com.nexus.iptv.domain.usecase.SyncProvider
import com.nexus.iptv.domain.usecase.SyncProviderCommand
import com.nexus.iptv.domain.usecase.SyncProviderResult
import com.nexus.iptv.player.AudioCompatibilityMemoryStore
...
class SettingsViewModel @Inject constructor(
    ...
    private val playbackHistoryRepository: com.nexus.iptv.domain.repository.PlaybackHistoryRepository,
    ...
    private val epgSourceRepository: com.nexus.iptv.domain.repository.EpgSourceRepository,
    ...
    private fun com.nexus.iptv.diagnostics.CrashReportSummary.toUiModel(): CrashReportUiModel =
        CrashReportUiModel(
            timestamp = timestamp,
            exception = exception,
            fileName = fileName,
    ...
    fun setPlayerSurfaceMode(mode: com.nexus.iptv.domain.model.PlayerSurfaceMode) {
        viewModelScope.launch {
