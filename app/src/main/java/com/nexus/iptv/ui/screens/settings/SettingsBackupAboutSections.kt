...
import com.nexus.iptv.ui.theme.Secondary
...
internal fun LazyListScope.settingsAboutSection(
    ...
    item {
        ...
        LaunchedEffect(downloadStatus) {
            if (downloadStatus == com.nexus.iptv.update.AppUpdateDownloadStatus.Downloading) {
                while (true) {
        ...
        if (shouldShowUpdateDownloadAction(uiState.appUpdate)) {
            ClickableSettingsRow(
                ...
                onClick = {
                    if (uiState.appUpdate.downloadStatus == com.nexus.iptv.update.AppUpdateDownloadStatus.Downloaded) {
                        onInstallDownloadedUpdate()
                    } else if (uiState.appUpdate.downloadStatus != com.nexus.iptv.update.AppUpdateDownloadStatus.Downloading) {
