...
import com.nexus.iptv.data.remote.http.DefaultUserAgentInterceptor
import com.nexus.iptv.data.remote.http.buildAppRequestProfile
import com.nexus.iptv.data.remote.http.buildAppUserAgent
import com.nexus.iptv.data.remote.stalker.OkHttpStalkerApiService
...
import com.nexus.iptv.player.PlaybackSupportSnapshotStore
...
object NetworkModule {
    ...
    fun provideMainPlayerEngine(
        ...
        playbackCompatibilityRepository: com.nexus.iptv.domain.repository.PlaybackCompatibilityRepository,
