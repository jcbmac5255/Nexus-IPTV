...
data class BackupData(
    ...
    val favorites: List<com.nexus.iptv.domain.model.Favorite>? = null,
    val virtualGroups: List<com.nexus.iptv.domain.model.VirtualGroup>? = null,
...
interface BackupManager {
     ...
     */
    suspend fun exportConfig(uriString: String): com.nexus.iptv.domain.model.Result<Unit>
