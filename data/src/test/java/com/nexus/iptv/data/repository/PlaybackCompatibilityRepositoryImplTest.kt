...
import com.nexus.iptv.data.local.dao.PlaybackCompatibilityDao
import com.nexus.iptv.data.local.entity.PlaybackCompatibilityRecordEntity
...
class PlaybackCompatibilityRepositoryImplTest {
    ...
    private fun readDaoSource(): String {
        val candidates = listOf(
            Paths.get("src", "main", "java", "com", "nexus", "iptv", "data", "local", "dao", "Daos.kt"),
            Paths.get("data", "src", "main", "java", "com", "nexus", "iptv", "data", "local", "dao", "Daos.kt")
        )
