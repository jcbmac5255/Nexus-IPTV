...
import com.nexus.iptv.data.local.dao.SeriesCategoryHydrationDao
import com.nexus.iptv.data.local.dao.XtreamContentIndexDao
import com.nexus.iptv.data.local.entity.EpisodeBrowseEntity
import com.nexus.iptv.data.local.entity.EpisodeEntity
import com.nexus.iptv.data.local.entity.SeriesEntity
import com.nexus.iptv.data.local.entity.SeriesBrowseEntity
import com.nexus.iptv.data.local.entity.ProviderEntity
import com.nexus.iptv.data.preferences.PreferencesRepository
import com.nexus.iptv.data.remote.dto.XtreamSeason
...
import com.nexus.iptv.data.remote.stalker.StalkerEpisodeRecord
import com.nexus.iptv.data.remote.stalker.StalkerItemRecord
import com.nexus.iptv.data.remote.stalker.StalkerPagedItems
import com.nexus.iptv.data.remote.stalker.StalkerProviderProfile
import com.nexus.iptv.data.remote.stalker.StalkerSeasonRecord
import com.nexus.iptv.data.remote.stalker.StalkerSeriesDetails
...
class SeriesRepositoryImplTest {
    ...
    fun `stalker series preview loads only first page`() = runTest {
        ...
        whenever(categoryDao.getByProviderAndType(7L, ContentType.SERIES.name)).thenReturn(
            flowOf(listOf(com.nexus.iptv.data.local.entity.CategoryEntity(providerId = 7L, categoryId = 77L, name = "Drama", type = ContentType.SERIES)))
        )
        whenever(providerDao.getById(7L)).thenReturn(
            ProviderEntity(
                id = 7L,
    ...
    fun `getSeriesDetails falls back to remote series id lookup`() = runTest {
        ...
        assertThat(result).isInstanceOf(com.nexus.iptv.domain.model.Result.Success::class.java)
        val series = (result as com.nexus.iptv.domain.model.Result.Success).data
