...
import com.nexus.iptv.data.local.dao.MovieCategoryHydrationDao
...
import com.nexus.iptv.data.local.entity.MovieBrowseEntity
import com.nexus.iptv.data.local.entity.MovieEntity
import com.nexus.iptv.data.local.entity.PlaybackHistoryLiteEntity
import com.nexus.iptv.data.local.entity.ProviderEntity
import com.nexus.iptv.data.preferences.PreferencesRepository
import com.nexus.iptv.data.remote.stalker.StalkerDeviceProfile
...
class MovieRepositoryImplTest {
    ...
    fun `stalker movie preview loads only first page`() = runTest {
        ...
        whenever(categoryDao.getByProviderAndType(7L, ContentType.MOVIE.name)).thenReturn(
            flowOf(listOf(com.nexus.iptv.data.local.entity.CategoryEntity(providerId = 7L, categoryId = 42L, name = "Action", type = ContentType.MOVIE)))
        )
        whenever(providerDao.getById(7L)).thenReturn(
            ProviderEntity(
                id = 7L,
