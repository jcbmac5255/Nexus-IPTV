...
class RecordingReconcileWorker(
    ...
    interface RecordingWorkerEntryPoint {
        fun recordingManager(): com.nexus.iptv.domain.manager.RecordingManager
    }
    ...
    override suspend fun doWork(): Result {
        ...
        return when (manager.reconcileRecordingState()) {
            is com.nexus.iptv.domain.model.Result.Success -> Result.success()
            is com.nexus.iptv.domain.model.Result.Error -> Result.retry()
            com.nexus.iptv.domain.model.Result.Loading -> Result.retry()
        }
    }
