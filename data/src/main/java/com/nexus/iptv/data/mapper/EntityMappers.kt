package com.nexus.iptv.data.mapper

import com.google.gson.Gson
import com.google.gson.reflect.TypeToken
import com.nexus.iptv.data.local.entity.*
import com.nexus.iptv.data.remote.xtream.XtreamStreamKind
...
fun CategoryEntity.toDomain() = com.nexus.iptv.domain.model.Category(
    id = categoryId,
    roomId = id,
    name = name,
    parentId = parentId,
...
fun com.nexus.iptv.domain.model.Category.toEntity(providerId: Long) = CategoryEntity(
    categoryId = id,
    name = name,
    parentId = parentId,
    type = type,
...
fun SyncMetadataEntity.toDomain() = SyncMetadata(
    ...
    movieSyncMode = runCatching { com.nexus.iptv.domain.model.VodSyncMode.valueOf(movieSyncMode) }
        .getOrDefault(com.nexus.iptv.domain.model.VodSyncMode.UNKNOWN),
...
fun EpgSourceEntity.toDomain() = com.nexus.iptv.domain.model.EpgSource(
    id = id,
    name = name,
    url = url,
    enabled = enabled,
...
fun com.nexus.iptv.domain.model.EpgSource.toEntity() = EpgSourceEntity(
    id = id,
    name = name,
    url = url,
    enabled = enabled,
...
fun com.nexus.iptv.data.local.dao.ProviderEpgSourceWithDetails.toDomain() =
    com.nexus.iptv.domain.model.ProviderEpgSourceAssignment(
        id = id,
        providerId = providerId,
...
fun com.nexus.iptv.domain.model.ProviderEpgSourceAssignment.toEntity() = ProviderEpgSourceEntity(
    id = id,
    providerId = providerId,
    epgSourceId = epgSourceId,
    priority = priority,
...
fun EpgChannelEntity.toDomain() = com.nexus.iptv.domain.model.EpgChannelInfo(
    id = id,
    epgSourceId = epgSourceId,
...
fun ChannelEpgMappingEntity.toDomain() = com.nexus.iptv.domain.model.ChannelEpgMapping(
    id = id,
    providerChannelId = providerChannelId,
    providerId = providerId,
    sourceType = runCatching { com.nexus.iptv.domain.model.EpgSourceType.valueOf(sourceType) }
        .getOrDefault(com.nexus.iptv.domain.model.EpgSourceType.NONE),
    epgSourceId = epgSourceId,
    xmltvChannelId = xmltvChannelId,
    matchType = matchType?.let {
        runCatching { com.nexus.iptv.domain.model.EpgMatchType.valueOf(it) }.getOrNull()
    },
...
fun com.nexus.iptv.domain.model.ChannelEpgMapping.toEntity() = ChannelEpgMappingEntity(
    id = id,
    providerChannelId = providerChannelId,
    providerId = providerId,
