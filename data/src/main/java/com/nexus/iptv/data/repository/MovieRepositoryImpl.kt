...
import com.nexus.iptv.data.local.entity.MovieCategoryHydrationEntity
...
import com.nexus.iptv.data.sync.ContentCachePolicy
import com.nexus.iptv.data.sync.SyncManager
import com.nexus.iptv.data.util.rankSearchResults
import com.nexus.iptv.data.util.toFtsPrefixQuery
...
import com.nexus.iptv.domain.model.Result.Success
...
class MovieRepositoryImpl @Inject constructor(
    ...
    private fun com.nexus.iptv.data.local.entity.MovieEntity.hasFreshXtreamDetails(now: Long = System.currentTimeMillis()): Boolean {
